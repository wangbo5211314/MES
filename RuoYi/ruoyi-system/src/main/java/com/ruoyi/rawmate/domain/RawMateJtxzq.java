...
/**
 * 晶体谐振器对象 raw_mate_jtxzq
 * 
 * @author wangbo
 * @date 2020-12-11
 */
public class RawMateJtxzq extends BaseEntity
{
    private static final long serialVersionUID = 1L;

    /** 晶体谐振器ID */
    private Long jtxzqId;
    ...
    /** 频差实测值(PPM) */
    @Excel(name = "频差实测值(PPM)")
    private BigDecimal plcActValue;

    /** 晶体谐振器检测结论 */
    @Excel(name = "晶体谐振器检测结论")
    private String jtxzqTestResult;
    ...
    public void setJtxzqId(Long jtxzqId) 
    {
        this.jtxzqId = jtxzqId;
    }

    public Long getJtxzqId() 
    {
        return jtxzqId;
    }
    ...
    public void setPlcActValue(BigDecimal plcActValue) 
    {
        this.plcActValue = plcActValue;
    }

    public BigDecimal getPlcActValue() 
    {
        return plcActValue;
    }
    public void setJtxzqTestResult(String jtxzqTestResult) 
    {
        this.jtxzqTestResult = jtxzqTestResult;
    }

    public String getJtxzqTestResult() 
    {
        return jtxzqTestResult;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("plcActValue", getPlcActValue())
            .append("jtxzqTestResult", getJtxzqTestResult())
            .append("yl", getYl())
            .append("yl2", getYl2())
            .append("yl3", getYl3())
            .append("yl4", getYl4())
