...
/**
 * 瞬变二极管对象 raw_mate_sbejg
 * 
 * @author wangbo
 * @date 2020-12-11
 */
public class RawMateSbejg extends BaseEntity
{
    private static final long serialVersionUID = 1L;

    /** 瞬变二极管ID */
    private Long sbejgId;
    ...
    /** 漏电流实测值(μA) */
    @Excel(name = "漏电流实测值(μA)")
    private BigDecimal melecActValue;

    /** 瞬变二极管检测结论 */
    @Excel(name = "瞬变二极管检测结论")
    private String sbejgTestResult;
    ...
    public void setSbejgId(Long sbejgId) 
    {
        this.sbejgId = sbejgId;
    }

    public Long getSbejgId() 
    {
        return sbejgId;
    }
    ...
    public void setMelecActValue(BigDecimal melecActValue) 
    {
        this.melecActValue = melecActValue;
    }

    public BigDecimal getMelecActValue() 
    {
        return melecActValue;
    }
    public void setSbejgTestResult(String sbejgTestResult) 
    {
        this.sbejgTestResult = sbejgTestResult;
    }

    public String getSbejgTestResult() 
    {
        return sbejgTestResult;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("melecActValue", getMelecActValue())
            .append("sbejgTestResult", getSbejgTestResult())
            .append("yl", getYl())
            .append("yl2", getYl2())
            .append("yl3", getYl3())
            .append("yl4", getYl4())
