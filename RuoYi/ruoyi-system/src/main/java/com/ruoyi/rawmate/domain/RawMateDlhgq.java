...
/**
 * 电流互感器对象 raw_mate_dlhgq
 * 
 * @author wangbo
 * @date 2020-12-11
 */
public class RawMateDlhgq extends BaseEntity
{
    private static final long serialVersionUID = 1L;

    /** 电流互感器ID */
    private Long dlhgqId;
    ...
    /** 电流互感器检测结论 */
    @Excel(name = "电流互感器检测结论")
    private String dlhgqTestResult;
    ...
    public void setDlhgqId(Long dlhgqId) 
    {
        this.dlhgqId = dlhgqId;
    }

    public Long getDlhgqId() 
    {
        return dlhgqId;
    }
    ...
    public void setDlhgqTestResult(String dlhgqTestResult) 
    {
        this.dlhgqTestResult = dlhgqTestResult;
    }

    public String getDlhgqTestResult() 
    {
        return dlhgqTestResult;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("diffValue", getDiffValue())
            .append("dlhgqTestResult", getDlhgqTestResult())
            .append("yl", getYl())
            .append("yl2", getYl2())
            .append("yl3", getYl3())
            .append("yl4", getYl4())
